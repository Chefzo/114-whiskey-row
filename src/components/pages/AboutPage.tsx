...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* ===== HERO SECTION ===== */}
      <section className="relative w-full flex items-center justify-center pt-24 md:pt-32 pb-0 px-4 sm:px-6 md:px-16 overflow-hidden min-h-[60vh] md:min-h-[70vh]">
        ...
        <div className="relative z-10 w-full max-w-[120rem] mx-auto text-left flex flex-col justify-center min-h-[60vh] md:min-h-[70vh]">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <h1 className="font-heading text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-tight text-foreground mb-6 sm:mb-8">
              About One Fourteen | Whiskey Row Bar in Louisville
            </h1>
            <p className="font-paragraph text-base sm:text-lg md:text-xl text-foreground/80 leading-relaxed max-w-2xl">
      ...
      <section className="w-full py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-16 border-t border-neon-red-orange/20">
        <div className="max-w-[120rem] mx-auto">
          ...
          >
            {/* Opening Block */}
            <motion.div variants={itemVariants} className="max-w-2xl space-y-4 sm:space-y-5">
            ...
            <motion.div variants={itemVariants} className="max-w-2xl space-y-6 sm:space-y-8">
            ...
            {/* Closing Block */}
            <motion.div variants={itemVariants} className="max-w-2xl space-y-4 sm:space-y-5 pt-6 sm:pt-8 border-t border-neon-red-orange/20">
              <p className="font-paragraph text-base sm:text-lg md:text-xl text-foreground/90 leading-relaxed">
              ...
              <div className="pt-4 sm:pt-6">
                <p className="font-handwriting text-2xl sm:text-3xl md:text-4xl text-neon-red-orange leading-relaxed">
                  That's One Fourteen.
                </p>
              </div>
            </motion.div>
            ...
            {/* Location Block */}
            <motion.div variants={itemVariants} className="max-w-2xl space-y-2 pt-4 sm:pt-6">
              <p className="font-paragraph text-base sm:text-lg md:text-xl text-foreground/80 leading-relaxed">
